...
############ ALGORITHM ##########################################
SecondAllocationAlgoV1<- function(callId_vec,callInfo_df,resource_vec,pref_vec,deselectAssetId,deselectCallId,currentSelection_list,availAsset_df,assetInfo_df){
