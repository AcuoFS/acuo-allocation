...
callInfoPath <- "testNoncashInternal/callInfo.xlsx"
assetInfoPath <- "testNoncashInternal/assetInfo.xlsx"
availAssetPath <- "testNoncashInternal/availAsset.xlsx"
externalCostPath <- "testNoncashInternal/externalCost.xlsx"
...
for(i in 1:length(assetScenarios)){
  ...
  save.image(paste("testNoncashInternal/RData/callNumber10AssetNumber",assetScenarios[i],".RData",sep=""))
}
