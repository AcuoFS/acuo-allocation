...
testExternalNoncashScenario1Data1Pref1 <- function(){
  # load data
...
testExternalNoncashScenario1Data1Pref2 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashScenario1Data1Pref3 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashScenario1Data1Pref4 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashScenario1Data1Pref5 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
