...
## scenario 5: 
# internal cost cash: 0.5bps/day
internalCostCash <- 0.5/10000
# internal cost noncash: 0.3bps/day
internalCostNoncash <- 0.3/10000
# test external cost range: 0.07~0.42bps/day
####

testExternalNoncashSuffScenario1Data1Pref1 <- function(){
  # load data
...
testExternalNoncashSuffScenario1Data1Pref2 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashSuffScenario1Data1Pref3 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashSuffScenario1Data1Pref4 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
...
testExternalNoncashSuffScenario1Data1Pref5 <- function(){
  # load data
  loadPath <- paste(paste(loadFolder,loadFile,sep = '/'),"RData",sep=".")
  load(loadPath)
