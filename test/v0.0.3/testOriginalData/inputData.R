...
callInfoPath <- "testOriginalData/callInfo.xlsx"
assetInfoPath <- "testOriginalData/assetInfo.xlsx"
availAssetPath <- "testOriginalData/availAsset.xlsx"
externalCostPath <- "testOriginalData/externalCost.xlsx"
...
for(i in 1:length(assetScenarios)){
  ...
  save.image(paste("testOriginalData/RData/callNumber10AssetNumber",assetScenarios[i],".RData",sep=""))
}
