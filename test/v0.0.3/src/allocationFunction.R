...
AllocationAlgo <- function(callId_vec,resource_vec,resourceOri_vec,callInfo_df,availAsset_df,availAssetOri_df,
  ...
  resultAnalysisActualCost <- ResultAnalysisActualCost(availAssetOri_df,availAsset_df,resourceOri_df,resource_df,callInfo_df,callOutput_list)
  ...
  return(list(#msOutput=msOutput_list,
    ...
    solverStatus=solverStatus,solverObjValue=solverObjValue,resultAnalysis=resultAnalysis,resultAnalysisActualCost=resultAnalysisActualCost))
}
