...
testClientAvailAssetDetailsByPassingAExistentClientIdAndAListOfExistentCallIdsWhichDirectToTheClient <- function(){ 
  ...
  checkTrue(setequal(result$CustodianAccount[callId=='mc4'],c('CustodianAccount1E')))
  checkTrue(setequal(result$CustodianAccount[callId=='mc5'],c('CustodianAccount1D')))
  checkTrue(setequal(result$CustodianAccount[callId=='mc8'],c('CustodianAccount1E','CustodianAccount1D')))
  checkTrue(setequal(result$CustodianAccount[callId=='mc12'],c('CustodianAccount1A','CustodianAccount1B','CustodianAccount1C','CustodianAccount1E','CustodianAccount1D')))
  checkTrue(setequal(result$CustodianAccount[callId=='mc16'],c('CustodianAccount1C','CustodianAccount1D')))
  ...
  checkTrue(setequal(result$totalQuantity[assetId=='USD' & custAccount=='CustodianAccount1D'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='USD' & custAccount=='CustodianAccount1D'],0.01))
  checkTrue(setequal(result$opptCost[assetId=='USD' & custAccount=='CustodianAccount1D'],0.01))
  checkTrue(setequal(result$currency[assetId=='USD' & custAccount=='CustodianAccount1D'],'USD'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='GBP' & custAccount=='CustodianAccount1D'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='GBP' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$opptCost[assetId=='GBP' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$currency[assetId=='GBP' & custAccount=='CustodianAccount1D'],'GBP'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='JPY' & custAccount=='CustodianAccount1D'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='JPY' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$opptCost[assetId=='JPY' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$currency[assetId=='JPY' & custAccount=='CustodianAccount1D'],'JPY'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='CAD' & custAccount=='CustodianAccount1E'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='CAD' & custAccount=='CustodianAccount1E'],0.01))
  checkTrue(setequal(result$opptCost[assetId=='CAD' & custAccount=='CustodianAccount1E'],0.01))
  checkTrue(setequal(result$currency[assetId=='CAD' & custAccount=='CustodianAccount1E'],'CAD'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='SGD' & custAccount=='CustodianAccount1D'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='SGD' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$opptCost[assetId=='SGD' & custAccount=='CustodianAccount1D'],0.006))
  checkTrue(setequal(result$currency[assetId=='SGD' & custAccount=='CustodianAccount1D'],'SGD'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='AUD' & custAccount=='CustodianAccount1E'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='AUD' & custAccount=='CustodianAccount1E'],0.018))
  checkTrue(setequal(result$opptCost[assetId=='AUD' & custAccount=='CustodianAccount1E'],0.018))
  checkTrue(setequal(result$currency[assetId=='AUD' & custAccount=='CustodianAccount1E'],'AUD'))
  
  checkTrue(setequal(result$totalQuantity[assetId=='EUR' & custAccount=='CustodianAccount1D'],5000000))
  checkTrue(setequal(result$internalCost[assetId=='EUR' & custAccount=='CustodianAccount1D'],0.004))
  checkTrue(setequal(result$opptCost[assetId=='EUR' & custAccount=='CustodianAccount1D'],0.004))
  checkTrue(setequal(result$currency[assetId=='EUR' & custAccount=='CustodianAccount1D'],'EUR'))
