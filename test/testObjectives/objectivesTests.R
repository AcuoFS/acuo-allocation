...
testCallNumber10AssetNumberS20M20L10Pref1 <- function(){
  ...
  output <- cbind("callNumber10AssetNumberS20M20L10.RData",pref_vec[1],pref_vec[2],timeLimit,runTime,analysis$dailyCost,analysis$reservedLiquidityRatio,analysis$movements)
...
testCallNumber10AssetNumberS20M20L10Pref3 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
  pref_vec <- pref3
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
...
testCallNumber10AssetNumberS20M20L10Pref4 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
  pref_vec <- pref4
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
...
testCallNumber10AssetNumberS20M20L10Pref5 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
  pref_vec <- pref5
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
