...
testCallNumber10AssetNumberS10M32L5SL3Pref1 <- function(){
...
testCallNumber10AssetNumberS10M32L5SL3Pref2 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M32L5SL3.RData")
  pref_vec <- pref2
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
...
testCallNumber10AssetNumberS10M32L5SL3Pref3 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M32L5SL3.RData")
  pref_vec <- pref3
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
...
testCallNumber10AssetNumberS10M32L5SL3Pref4 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M32L5SL3.RData")
  pref_vec <- pref4
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
...
testCallNumber10AssetNumberS10M32L5SL3Pref5 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M32L5SL3.RData")
  pref_vec <- pref5
  timeLimit <- 10
  worksheet <- readWorksheetFromFile(filePath,sheet="Results")
