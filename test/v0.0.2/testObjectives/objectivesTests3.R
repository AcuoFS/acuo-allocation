...
testCallNumber10AssetNumberS10M35L5Pref1 <- function(loadFile=data1){
...
testCallNumber10AssetNumberS10M35L5Pref2 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
  pref_vec <- pref2
  timeLimit <- 10
...
testCallNumber10AssetNumberS10M35L5Pref3 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
  pref_vec <- pref3
  timeLimit <- 10
...
testCallNumber10AssetNumberS10M35L5Pref4 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
  pref_vec <- pref4
  timeLimit <- 10
...
testCallNumber10AssetNumberS10M35L5Pref5 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
  pref_vec <- pref5
  timeLimit <- 10
