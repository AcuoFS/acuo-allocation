...
#### checkFunctions #######
AdjustResultVec <- function(solution_vec,varNum,varName_vec,
...
VarInfo <- function(eli_vec,callInfo_df,resource_vec,callId_vec){
  ...
  varName_vec <- c(varNameOri_vec)
  varNum <- length(varNameOri_vec)
  
  var_list <- list(varName_vec=varName_vec,varNum=varNum)
  return(var_list)
}
