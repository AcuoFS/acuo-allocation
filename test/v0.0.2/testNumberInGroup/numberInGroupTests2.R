...
testCallNumber10AssetNumberS10M35L5Group1 <- function(){
  ...
  output <- cbind("callNumber10AssetNumberS10M35L5.RData",inputLimit_vec[4],timeLimit,runTime,analysis$dailyCost,analysis$reservedLiquidityRatio,analysis$movements)
  writeWorksheetToFile(filePath,data=output,sheet='Results',startRow=length(worksheet[,1])+2,startCol=1,header=F)
  
}

testCallNumber10AssetNumberS10M35L5Group2 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M35L5.RData")
...
testCallNumber10AssetNumberS10M35L5Group3 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M35L5.RData")
...
testCallNumber10AssetNumberS10M35L5Group4 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M35L5.RData")
...
testCallNumber10AssetNumberS10M35L5Group5 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS10M35L5.RData")
