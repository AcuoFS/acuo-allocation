...
data1 <- "callNumber10AssetNumberS10M35L5.RData"


testCallNumber10AssetNumberS10M35L5Group1 <- function(loadFile=data1){
...
testCallNumber10AssetNumberS10M35L5Group2 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
...
testCallNumber10AssetNumberS10M35L5Group3 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
...
testCallNumber10AssetNumberS10M35L5Group4 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
...
testCallNumber10AssetNumberS10M35L5Group5 <- function(loadFile=data1){
  loadPath <- paste(loadFolder,loadFile,sep = '/')
  load(loadPath)
