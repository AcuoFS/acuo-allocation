...
testCallNumber10AssetNumberS20M20L10Group1 <- function(){
  ...
  output <- cbind("callNumber10AssetNumberS20M20L10.RData",inputLimit_vec[4],timeLimit,runTime,analysis$dailyCost,analysis$reservedLiquidityRatio,analysis$movements)
  writeWorksheetToFile(filePath,data=output,sheet='Results',startRow=length(worksheet[,1])+2,startCol=1,header=F)
  
}

testCallNumber10AssetNumberS20M20L10Group2 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
...
testCallNumber10AssetNumberS20M20L10Group3 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
...
testCallNumber10AssetNumberS20M20L10Group4 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
...
testCallNumber10AssetNumberS20M20L10Group5 <- function(){
  load("test/testAssetAmount/callNumber10AssetNumberS20M20L10.RData")
