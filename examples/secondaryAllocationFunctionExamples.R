...
current.selection <- allocationAlgo(callId=callId,clientId=clientId,pref=pref)$output  
...
result1 <- secondAllocationFunction(callIds,clientId,pref,deselectAssetId,deselectCallId,current.selection,availAssets)
