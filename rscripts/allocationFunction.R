...
AllocationAlgo <- function(callId_vec,resource_vec,callInfo_df,availAsset_df,assetInfo_df,pref_vec,timeLimit,verbose,inputLimit_vec,callOrderMethod){
  ########### CONSTANTS ################################
  ...
  for(i in 1:length(groupCallId_list)){
    ...
    resultGroup_list <- CoreAlgo(coreInput_list,availAssetGroup_df,pref_vec,timeLimit,verbose)
